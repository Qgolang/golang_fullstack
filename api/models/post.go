...
// Prepare Chuẩn bị data cho bài viết
func (p *Post) Prepare() {
	p.ID = 0
...
// Validate Kiểm tra bài viết hợp lệ
...
// FindAllPosts Tìm kiếm bài viết
...
// FindPostByID Tìm kiếm bài viết bởi pid
